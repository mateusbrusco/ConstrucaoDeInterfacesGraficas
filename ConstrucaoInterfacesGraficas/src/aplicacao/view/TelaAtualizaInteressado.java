...
public class TelaAtualizaInteressado extends JFrame {
	...
	public TelaAtualizaInteressado() {
	...
	private void criarComponentes() {
		...
		lblTitulo = new JLabel("ATUALIZA CADASTRO DE INTERESSADO(A)");
	...
	private void configurarComponentes() {
		...
		this.setTitle("Atualiza Cadastro de Interessado(a)");
		...
		btnAtualizar.setBounds(10, 468, 100, 37);
